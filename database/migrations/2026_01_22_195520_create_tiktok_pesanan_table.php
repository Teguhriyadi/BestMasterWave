...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tiktok_pesanan', function (Blueprint $table) {
            ...
            $table->bigInteger("sku_unit_original")->default(0);
            $table->bigInteger("sku_subtotal_before_discount")->default(0);
            $table->bigInteger("sku_platform_discount")->default(0);
            $table->bigInteger("sku_seller_discount")->default(0);
            $table->bigInteger("sku_subtotal_after_discount")->default(0);
            $table->bigInteger("shipping_fee_after_discount")->default(0);
            $table->bigInteger("original_shipping_fee")->default(0);
            $table->bigInteger("shipping_fee_seller_discount")->default(0);
            $table->bigInteger("shipping_fee_platform_discount")->default(0);
            $table->bigInteger("payment_platform_discount")->default(0);
            $table->bigInteger("buyer_service_fee")->default(0);
            $table->bigInteger("handling_fee")->default(0);
            $table->bigInteger("shipping_insurance")->default(0);
            $table->bigInteger("item_insurance")->default(0);
            $table->bigInteger("order_amount")->default(0);
            $table->bigInteger("order_refund_amount")->default(0);
