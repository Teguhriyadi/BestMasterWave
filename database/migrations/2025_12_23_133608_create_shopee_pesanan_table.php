...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('shopee_pesanan', function (Blueprint $table) {
            ...
            $table->string("status_pesanan", 100)->index()->nullable();
            $table->string("nama_seller")->nullable();
            $table->text("alasan_pembatalan")->nullable();
            $table->string("status_pembatalan", 150)->nullable()->index();
            $table->string("no_resi", 150)->nullable()->index()->nullable();
            $table->string("opsi_pengiriman", 150)->index()->nullable();
            $table->string("anter_ke_counter", 150)->index()->nullable();
            ...
            $table->string("sku_induk", 150)->nullable()->index();
