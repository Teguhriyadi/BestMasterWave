...
<a href="{{ url('/admin-panel/tiktok-pesanan/data') }}" class="btn btn-primary btn-sm mb-4">
    <i class="fa fa-book"></i> Kelola Data Tiktok Pesanan
</a>
<div class="card shadow">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">
            <i class="fa fa-upload"></i> Upload Excel Tiktok Pesanan
        </h6>
    </div>
    <div class="card-body">
...
<script>
    let uploadedFile = null;
        ...
        document.getElementById('file').addEventListener('change', function() {
            ...
            fetch("{{ url('admin-panel/tiktok-pesanan') }}", {
                    method: 'POST',
                    headers: {
        ...
        document.getElementById('process').addEventListener('click', function() {
            ...
            fetch("{{ url('admin-panel/tiktok-pesanan/process') }}", {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    },
