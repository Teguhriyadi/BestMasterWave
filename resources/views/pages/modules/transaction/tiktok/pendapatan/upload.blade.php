...
@push('content_app')
    ...
    <a href="{{ url('/admin-panel/tiktok-pendapatan/data') }}" class="btn btn-primary btn-sm mb-4">
        <i class="fa fa-book"></i> Kelola Data Tiktok Pendapatan
    </a>
    <div class="card shadow">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <i class="fa fa-upload"></i> Upload Excel Tiktok Pendapatan
            </h6>
        </div>
        <div class="card-body">
...
@push('js_style')
    ...
    <script>
        ...
        document.getElementById('file').addEventListener('change', function() {
            ...
            fetch("{{ url('admin-panel/tiktok-pendapatan') }}", {
                    method: 'POST',
                    headers: {
        ...
        document.getElementById('process').addEventListener('click', function() {
            ...
            fetch("{{ url('admin-panel/tiktok-pendapatan/process') }}", {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    },
