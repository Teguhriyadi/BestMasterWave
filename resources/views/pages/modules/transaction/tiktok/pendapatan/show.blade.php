...
@push('content_app')
    ...
    <h1 class="h3 mb-4 text-gray-800">Detail Tiktok Pendapatan</h1>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    @else
                        ...
                        <form action="{{ url('/admin-panel/tiktok-pendapatan/' . $file->id . '/process-database') }}"
                            method="POST">
                            @csrf
    ...
    <div class="modal fade" id="mappingModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <form method="POST"
                    action="{{ url('/admin-panel/tiktok-pendapatan/' . $file->id . '/process-database') }}">
                    @csrf
                    <input type="hidden" name="nama_seller" value="{{ $file->seller->nama }}">
