                ...
                <form action="{{ url('/admin-panel/karyawan') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <input type="number" name="id_sidik_jari" class="form-control @error('id_sidik_jari') is-invalid @enderror" id="id_sidik_jari"
                                    placeholder="Masukkan ID Sidik Jari" value="{{ old('id_sidik_jari') }}" min="1">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <select name="jabatan_id" class="form-control @error('jabatan') is-invalid @enderror" id="jabatan_id">
                                    <option value="">- Pilih -</option>
