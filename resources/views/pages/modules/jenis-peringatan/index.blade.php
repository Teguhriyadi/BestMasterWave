...
@push('title_module', 'Jenis Peringatan')
            ...
            <table class="table table-bordered nowrap" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th>Kode</th>
                        <th>Nama</th>
                        <th class="text-center">Level Peringatan</th>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ url('/admin-panel/jenis-peringatan') }}" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('kode') is-invalid @enderror"
                                        name="kode" id="kode" placeholder="Masukkan Kode Peringatan"
                                        value="{{ old('kode') }}">
                                    @error('kode')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control @error('nama_peringatan') is-invalid @enderror"
                                        name="nama_peringatan" id="nama_peringatan" placeholder="Masukkan Nama Jenis Denda"
                                        value="{{ old('nama_peringatan') }}">
...
@push('js_style')
    ...
    <script type="text/javascript">
        ...
        function editJenisPeringatan(id) {
            $.ajax({
                url: "{{ url('/admin-panel/jenis-peringatan') }}" + "/" + id + "/edit",
                type: "GET",
