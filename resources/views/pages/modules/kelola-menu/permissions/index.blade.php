                ...
                <form action="{{ url('/admin-panel/permissions') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" id="nama" placeholder="Masukkan Nama Modul" value="{{ old('nama') }}">
                            @error('nama')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('akses') is-invalid @enderror" name="akses" id="akses" placeholder="Masukkan Akses" value="{{ old('akses') }}">
                            @error('akses')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
