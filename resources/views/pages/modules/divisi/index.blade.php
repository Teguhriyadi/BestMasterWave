                    ...
                    @foreach ($divisi as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form action="{{ url('/admin-panel/divisi/' . $item['id']) }}" method="POST"
                ...
                <form action="{{ url('/admin-panel/divisi') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_divisi" id="nama_divisi" placeholder="Masukkan Nama Divisi" value="{{ old('nama_divisi') }}">
                        </div>
                    </div>
