<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item {{ Request::is('admin-panel/platform') || Request::is('admin-panel/seller') ? 'active' : '' }}">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
            aria-expanded="true" aria-controls="collapseTwo">
            <i class="fas fa-fw fa-book"></i>
            <span>Master</span>
        </a>
        <div id="collapseTwo" class="collapse {{ Request::is('admin-panel/platform') || Request::is('admin-panel/seller') ? 'show' : '' }} " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
